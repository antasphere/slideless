...
export const fr: Record<MessageKey, string> = {
  ...
  'invite.accountExists':
    'Un compte avec cette adresse existe déjà. Connectez-vous pour accepter l’invitation.',
  ...
  'tokens.colExpires': 'Expire',
  'tokens.colViews': 'Vues',
  'tokens.colLastAccess': 'Dernière ouverture',
  'tokens.colStatus': 'Statut',
  'tokens.modeLatest': 'Dernière version',
  'tokens.modePinned': 'Épinglé à la v{n}',
  'tokens.badgePassword': 'Mot de passe',
  'tokens.badgeAnnotate': 'Annotations',
  'tokens.badgeFormsOff': 'Formulaires désactivés',
  ...
  'collab.accountExists': 'Un compte avec cet e-mail existe déjà. Connectez-vous pour réclamer l’invitation.',
