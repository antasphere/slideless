...
export const fr: Record<MessageKey, string> = {
  ...
  'refs.sheetPreview': 'La version actuelle',
  ...
  'refs.audienceTitle': 'Qui la lit',
  'refs.switchWorkspace': 'Publiée dans l’espace de travail',
  'refs.readsPrivate':
    'Seuls son propriétaire, les administrateurs de l’espace de travail et les personnes invitées sur cette présentation la lisent.',
  'refs.readsWorkspace': 'Chaque membre de l’espace de travail la lit, avec ses versions et ses fichiers.',
  'refs.refuseDefaultPrivate':
    'C’est le {type} par défaut de l’espace de travail. Retirez ce statut avant de le rendre privé.',
  'refs.refuseAudiencePrivate':
    'Publiez d’abord dans l’espace de travail : un {type} par défaut est lu par chaque membre.',
  'refs.published': 'Publiée dans l’espace de travail.',
  'refs.madePrivate': 'De nouveau privée.',
  ...
  'refs.defaultSet': 'C’est maintenant le {type} par défaut de l’espace de travail.',
  'refs.defaultCleared': 'L’espace de travail n’a plus de {type} par défaut.',
