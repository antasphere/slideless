...
const INVOKERS: Record<string, (c: PlatformClient) => Promise<unknown>> = {
  ...
  'PUT /presentations/{id}/projects/{projectId}': (c) => c.linkPresentationProject(SAMPLE_ID, SAMPLE_ID),
  'DELETE /presentations/{id}/projects/{projectId}': (c) => c.unlinkPresentationProject(SAMPLE_ID, SAMPLE_ID),
