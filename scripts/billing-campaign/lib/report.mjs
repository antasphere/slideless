...
export class Report {
  ...
  markdown(finishedAt) {
    ...
    lines.push('');
    lines.push(`Started ${this.startedAt.toISOString()}, finished ${finishedAt.toISOString()} (${Math.round(ms / 60000)} min). Hub ${this.heads.hub}, Slideless ${this.heads.slideless}, pair ${this.heads.pair}. The Stripe sandbox only; nothing charged to a real person.`);
    lines.push('');
