...
| `slideless_add_share_token`           | write | Mint a share link (name/pin/annotate/forms/downloads/expiry/password, see [Share links](../concepts/links.md)); returns the viewer URL once                                                       |
