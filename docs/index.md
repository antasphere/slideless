...
- **Links are made on top.** A share link is a secret URL that opens the deck for whoever holds it,
  following the latest version or pinned to one, with its own switches (annotations, forms,
  downloads), an expiry, a password, view counts and instant revocation. A link is public to anyone
